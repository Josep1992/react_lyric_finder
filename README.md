# Lyrics Finder 
This project is a tutorial from Brad traversy Youtube Channel [Direct Link to the project videos here](https://www.youtube.com/watch?v=NDEt0KdDbhk&t=7s). The project differs in the api call im using async and await instead, some layout might be different. The purpose of this tutorial is to understand the react context api. 

> To run the project properly you will need a API key from the musixmatch developer website [here](https://developer.musixmatch.com/) the key is stored as a __.env variable__ in the root of the project.
```
REACT_APP_MM_KEY={api key goes here}
```
